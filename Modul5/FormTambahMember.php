...
if (isset($_POST['submit'])) {
    ...
    if (tambahMember($nama, $nomor, $alamat, $tgl_mendaftar, $tgl_terakhir_bayar)) {
        echo "<script>
                alert('Data member berhasil ditambahkan!');
                window.location.href = 'Member.php';
              </script>";
    } else {
        echo "<script>alert('Gagal menambahkan data member.');</script>";
    }
}
?>
...
<head>
    ...
    <title>Tambah Member - Perpustakaan OPM</title>
        ...
        <div class="column has-background-dark is-flex is-flex-direction-column">
            ...
            <nav class="top-navbar">
                <div class="has-text-grey-light is-size-6">
                    Dashboard / Member / <span class="has-text-weight-bold has-text-white">Tambah Baru</span>
                </div>
            ...
            <div class="content-area flex-grow-1">
                <div class="form-container">
                    <h2 class="title is-3 mb-5 has-text-weight-bold has-text-white">Tambah Member Baru</h2>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input" type="text" name="nama_member" placeholder="Masukkan nama lengkap" required>
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input" type="text" name="nomor_member" placeholder="Contoh: M-001" required>
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <textarea class="textarea" name="alamat" placeholder="Masukkan alamat lengkap" rows="3" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input" type="datetime-local" name="tgl_mendaftar" required>
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input" type="date" name="tgl_terakhir_bayar" required>
