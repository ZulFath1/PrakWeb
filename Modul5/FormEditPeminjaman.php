...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $data_lama = getPeminjamanById($id);
} else {
...
if (isset($_POST['submit'])) {
    ...
    if (editPeminjaman($id, $id_member, $id_buku, $tgl_pinjam, $tgl_kembali)) {
        echo "<script>
...
<head>
    ...
    <title>Edit Peminjaman - Perpustakaan OPM</title>
        ...
        <div class="column has-background-dark is-flex is-flex-direction-column">
            ...
            <nav class="top-navbar">
                <div class="has-text-grey-light is-size-6">
                    Dashboard / Peminjaman / <span class="has-text-weight-bold has-text-white">Ubah Data</span>
                </div>
            ...
            <div class="content-area flex-grow-1">
                <div class="form-container">
                    <h2 class="title is-3 mb-5 has-text-weight-bold has-text-white">Ubah Data Peminjaman</h2>
                    ...
                    <div class="custom-box">
                        <form action="" method="post">
                                    ...
                                    <div class="select is-fullwidth">
                                        <select name="id_member" required>
                                            <?php foreach ($semua_member as $m) : ?>
                                                <option value="<?= $m['id_member'] ?>" <?= ($m['id_member'] == $data_lama['id_member']) ? 'selected' : '' ?>>
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input" type="date" name="tgl_pinjam" value="<?= $data_lama['tgl_pinjam'] ?>" required>
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input class="input" type="date" name="tgl_kembali" value="<?= $data_lama['tgl_kembali'] ?>" required>
